...
awful.key({ modkey,}, "F11", function() awful.util.spawn('mpd');awful.util.spawn("mpc toggle") end,
...
awful.key({ modkey, }, "v", function () awful.spawn("chromium --profile-directory=Default --app-id=hnpfjngllnobngcgfapefoaidbinmjnm") end,
{description = "Whatsapp", group = "launcher"}),
...
awful.key({ modkey }, "d", function () awful.util.spawn(APPS.launcher) end, {description = "launch app launcher", group = "launcher"}),
-- awful.key({ modkey,"Shift" }, "s", function () awful.util.spawn("shutdown now") end, {description = "Shutdown System", group = "launcher"}),
awful.key({ modkey }, "b", function () awful.util.spawn(APPS.browser) end, {description = "launch browser", group = "launcher"}),
awful.key({ modkey }, "e", function () awful.util.spawn(APPS.file_manager) end, {description = "launch File Manager", group = "launcher"}),
awful.key({ modkey, "Shift"}, "z", function () awful.spawn.with_shell('/home/mabona3/.config/awesome/scripts/screenshot') end, {description = "Take Screenshot", group = "launcher"}))
