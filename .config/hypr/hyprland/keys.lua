...
hl.bind(mainMod .. " + N", hl.dsp.exec_cmd("$HOME/.config/hypr/scripts/hyprpaper.sh 1"))
hl.bind(mainMod .. " + SHIFT + N", hl.dsp.exec_cmd("$HOME/.config/hypr/scripts/hyprpaper.sh"))

hl.bind(mainMod .. " + SHIFT + Z", hl.dsp.exec_cmd("grim -g \"$(slurp)\""))
hl.bind("PRINT", hl.dsp.exec_cmd("hyprshot -m window"))
hl.bind(mainMod .. " + PRINT", hl.dsp.exec_cmd("hyprshot -m region"))

hl.bind(mainMod .. " + Y", hl.dsp.exec_cmd("pidof swaync-client || swaync-client --close-all"))
hl.bind(mainMod .. " + T", hl.dsp.exec_cmd("pidof swaync-client || swaync-client -t"))

hl.bind(mainMod .. " + SHIFT + F11", hl.dsp.exec_cmd("playerctl --all-players play-pause"))
hl.bind("PAUSE", hl.dsp.exec_cmd("mpd & mpc toggle"))
hl.bind(mainMod .. " + F11", hl.dsp.exec_cmd("mpd & mpc toggle"))
hl.bind(mainMod .. " + F10", hl.dsp.exec_cmd("mpc prev"))
hl.bind(mainMod .. " + F12", hl.dsp.exec_cmd("mpc next"))
